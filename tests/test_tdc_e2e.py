...
tdc_e2e = importlib.import_module("features.tdc_e2e")
...
class TDCE2EFlowTests(unittest.TestCase):
    @patch("features.tdc_e2e.run_stages")
    def test_runs_tdc_amount_200_e2e_as_reportable_stages(self, run_stages_mock):
        ...
        self.assertEqual(
            ...
            [
                tdc_e2e.open_kiosco_run,
                tdc_e2e.login_run,
                tdc_e2e.sevenly_login_run,
                tdc_e2e.magna_amount_200_run,
                tdc_e2e.windows_run,
                tdc_e2e.print_ticket_run,
            ],
        )
