...
def run():
    ...
    if use_windows_path():
        ...
        save_screenshot("step_1_windows_desktop_visible")

        double_click_coordinates(*PETRO_KIOSK_ICON_COORDINATES)

        time.sleep(10)

        save_screenshot("step_2_desktop_icon_launch_attempt")
    else:
        # Conserva el lanzamiento historico usado desde macOS.
